...
import cn.org.chris.newlife.utils.StringUtil;
import cn.org.chris.newlife.core.ProjectConstant;
...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://127.0.0.1:3306/newlife";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "Richice";
    ...
    private static final String AUTHOR = "RichiceWoo";//@author
    ...
    public static void main(String[] args) {
        ...
        genCodeByCustomModelName("test_generator", "TestGenerator");
